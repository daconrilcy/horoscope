...
Ce module implémente un store Redis avec opérations atomiques pour le rate limiting
en multi-pods, utilisant des scripts Lua pour garantir la cohérence.
"""
    ...
    def _get_redis(self) -> redis.Redis:
        ...
        if self._redis is None:
            try:
                ...
                log.error("Failed to connect to Redis rate limit store", extra={"error": str(e)})
                raise
