...
Issue: **PH4.1-19** · Module: **cicd** · Type: **task** · Sévérité: **P2** · Due: **2025-10-31**
Dependencies: — · Tags: automation,embeddings
Branch: `feat/PH4.1-19-automatiser-github-workflows-embeddings-yml`
...
## Contexte
Déclencheurs sur changements contenu/modèle; artefacts signés.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-19** dans le module **cicd**.
