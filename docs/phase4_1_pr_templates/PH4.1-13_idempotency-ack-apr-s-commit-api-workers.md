...
Issue: **PH4.1-13** · Module: **backend** · Type: **feature** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: idempotency,celery
...
## Contexte
Accuser réception après commit DB, éviter doubles effets; tests intégration.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-13** dans le module **backend**.
...
- Implémenter strictement le périmètre de l'issue dans le module concerné.
