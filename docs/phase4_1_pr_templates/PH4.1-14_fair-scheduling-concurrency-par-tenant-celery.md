...
Issue: **PH4.1-14** · Module: **workers** · Type: **feature** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: celery,scheduling,tenant
Branch: `feat/PH4.1-14-fair-scheduling-concurrency-par-tenant-celery`
...
## Contexte
Limiter concurrency par tenant; WFQ; monitorer queue length; runbook.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-14** dans le module **workers**.
