...
Issue: **PH4.1-07** · Module: **performance** · Type: **task** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: bench,perf,multi-tenant
Branch: `feat/PH4.1-07-bench-multi-tenant-noisy-neighbor-warm-cold-rapport`
...
## Contexte
Scénarios multi-tenant; QPS par tenant; mesures P95/P99; top-k/chunk; rapport versionné.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-07** dans le module **performance**.
...
- Écrire `scripts/bench_multitenant.py` (QPS, tenants, warm/cold, noisy neighbor).
- Exporter le rapport JSON versionné (P95/P99 par endpoint).
