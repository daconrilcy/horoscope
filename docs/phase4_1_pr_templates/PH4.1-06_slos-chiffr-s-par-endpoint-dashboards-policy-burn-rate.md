...
Issue: **PH4.1-06** · Module: **observability** · Type: **feature** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: slo,burn-rate,grafana
Branch: `feat/PH4.1-06-slos-chiffr-s-par-endpoint-dashboards-policy-burn-rate`
...
## Contexte
Publier SLOs (P95/P99/err_rate) `slo.yaml`; dashboards; policy freeze auto > seuil.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-06** dans le module **observability**.
...
- Publier **SLOs par endpoint** dans `slo.yaml` (P95/P99/err_rate).
- `scripts/slo_report.py --fail-on-breach` ; dashboards burn-rate (1h/6h/24h).
