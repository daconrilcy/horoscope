...
# [PH4.1-10] API versioning `/v1` + deprecation policy

Issue: **PH4.1-10** · Module: **apigw** · Type: **task** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: versioning,deprecation
Branch: `feat/PH4.1-10-api-versioning-v1-deprecation-policy`
...
## Contexte
Forcer `/v1`, doc deprecation; routes legacy redirigées avec warning.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-10** dans le module **apigw**.
