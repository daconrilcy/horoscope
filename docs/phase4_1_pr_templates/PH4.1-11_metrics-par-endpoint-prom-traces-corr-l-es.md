...
Issue: **PH4.1-11** · Module: **observability** · Type: **task** · Sévérité: **P1** · Due: **2025-10-29**
Dependencies: — · Tags: metrics,tracing
...
## Contexte
Exposer `*_seconds_bucket`, `*_total` par route; `trace_id` logué.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-11** dans le module **observability**.
