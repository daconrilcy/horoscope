...
# [PH4.1-20] Evidence Pack: coverage JSON, SLO report, bench, snapshots

Issue: **PH4.1-20** · Module: **cicd** · Type: **task** · Sévérité: **P2** · Due: **2025-10-31**
Dependencies: — · Tags: evidence,artifacts,reporting
Branch: `feat/PH4.1-20-evidence-pack-coverage-json-slo-report-bench-snapshots`
...
## Contexte
Pipeline d’export des artefacts et versionnement.

## Scope (STRICT)
- Implémenter **uniquement** le périmètre de **PH4.1-20** dans le module **cicd**.
